...
public class Writer {
	...
	private static final String QUERY_INSERT_STUDENT = "INSERT INTO cliente (nombresapellidos, telefono, celular,"
			+ " correo, direccion, nitocedula, idtipocliente, idmunicipio) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
